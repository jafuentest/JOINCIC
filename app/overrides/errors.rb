	...
	class Errors
		begin
			@@default_error_messages = {
				...
				:too_long => "puede contener máximo %d caracteres",
				:too_short => "debe contener mínimo %d caracteres",
				:wrong_length => "debe tener %d caracteres",
				:taken => "ya ha sido usado",
		...
		module ActiveRecordHelper
			def error_messages_for(object_name, options = {})
				...
				unless object.errors.empty?
					content_tag("div", content_tag(options[:header_tag] || "h2", "Existen errores que impiden guardar el registro") +
